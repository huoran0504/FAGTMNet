...
parser.add_argument('--model_id', type=str, default='electricity', help='model id')
parser.add_argument('--model', type=str, default='StemGNNLinear',
                    help='model name, options: [NLinear, DLinear, FreLinear, FreTS_Linear, FreAttentionLinear, Linear, Autoformer, Informer, iTransformer,\
                     FreTS_LinearFourier_datu, TimesNet, MSGNet, PatchTSTLinear, TimesNet, AttentionLinear, InformerWithoutSlice, hjyLinear, GraphWaveNetLinear]')
