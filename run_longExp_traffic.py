...
parser.add_argument('--model', type=str, default='Linear',
                    help='model name, options: [NLinear, DLinear, FreLinear, FreTS_Linear, FreAttentionLinear, \
                    Linear, Autoformer, Informer, iTransformer, FreTS_LinearFourier_datu, MSGNet, PatchTSTLinear, TimesNet]')
...
# traffic数据集在MSGNet里面，d_model为1024
